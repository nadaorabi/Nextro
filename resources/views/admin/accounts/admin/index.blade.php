                ...
                <div class="col-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h1 class="text-gradient text-primary">Admin Management</h1>
                                    <p class="mb-0">Manage, add, and edit admin accounts</p>
                                </div>
                                <div class="col-lg-6 text-end">
                                    <a href="{{ route('admin.accounts.admins.create') }}" class="btn btn-primary mb-0">
                    ...
                    <div class="row mb-4">
                        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                            <div class="card stat-card primary">
                                ...
                                <div class="stat-description">
                                    <span class="highlight success">+{{ $adminsThisMonth }}</span> this month
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                            <div class="card stat-card success">
                                ...
                                <div class="stat-description">
                                    <span class="highlight success">{{ $totalAdmins > 0 ? round(($activeAdmins/$totalAdmins)*100) : 0 }}%</span> of admins
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card stat-card danger">
                                ...
                                <div class="stat-value">{{ $blockedAdmins }}</div>
                                <div class="stat-description">
            ...
            <div class="modal-content border-0 shadow">
                <div class="modal-header bg-danger text-white border-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="modal-title mb-0" id="deleteConfirmModalLabel">Confirm Admin Deletion</h5>
                ...
                <div class="modal-body p-4">
                    <div class="text-center mb-4">
                        ...
                        <h6 class="text-danger mb-2">Are you sure you want to delete this admin account?</h6>
                        ...
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <ul class="mb-0 mt-2 small">
                                    <li>Admin profile will be permanently removed</li>
                                    <li>All administrative records will be deleted</li>
                                    <li>All system access will be revoked</li>
                ...
                <div class="modal-footer border-0 bg-light">
                    ...
                    <form id="deleteForm" method="POST" style="display: inline;">
                        ...
                        <button type="submit" class="btn btn-secondary" disabled>
                            <i class="fas fa-trash me-2"></i>Delete Admin Account
                        </button>
                    </form>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="studentCardModalLabel">Admin ID Card</h5>
                    ...
                    <div class="card-preview">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="mb-1"><strong>Department:</strong> <span id="modal-student-level"></span></p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            studentCardModal.addEventListener('show.bs.modal', function (event) {
                ...
                modalTitle.textContent = 'Admin ID Card: ' + name;
        ...
        function printStudentCard() {
            ...
            const id = document.getElementById('modal-student-id').textContent;
            const level = document.getElementById('modal-student-level').textContent;
            const email = document.getElementById('modal-student-email').textContent;
            const regDate = document.getElementById('modal-student-reg-date').textContent;
            const avatar = document.getElementById('modal-student-avatar').src;
            ...
            printWindow.document.write(`
                ...
                <head>
                    ...
                    <style>
                        ...
                        .card { border: 3px solid #4f8cff; border-radius: 15px; padding: 20px; width: 400px; margin: 0 auto; }
                        .header { text-align: center; color: #4f8cff; margin-bottom: 20px; }
                ...
                <body>
                    <div class="card">
                        <div class="header">
                            <h2>Admin ID Card</h2>
                            <h3>Nextro Educational System</h3>
                        </div>
                        <div class="profile">
                            ...
                            <div class="info">
                                ...
                                <p><strong>Department:</strong> ${level}</p>
                                <p><strong>Email:</strong> ${email}</p>
                                <p><strong>Registration:</strong> ${regDate}</p>
                            </div>
                        </div>
                        <div class="qr">
                    ...
                    <script src="https://cdn.jsdelivr.net/npm/qrcode@1.5.3/build/qrcode.min.js"></script>
                    <script>
                        QRCode.toCanvas(document.getElementById('qrcode'), '${id}', function (error) {
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteModal.addEventListener('hidden.bs.modal', function() {
                ...
                submitBtn.innerHTML = '<i class="fas fa-trash me-2"></i>Delete Admin Account';
                submitBtn.disabled = true;

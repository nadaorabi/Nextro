...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Add hover effects to option cards for category modal
            const optionCards = document.querySelectorAll('#categoryCreatedModal .col-md-6 .border');
            ...
            // Add click effects to buttons for category modal
            const modalButtons = document.querySelectorAll('#categoryCreatedModal .btn');
            ...
            // Add animation to buttons for category modal
            setTimeout(() => {
                const buttons = document.querySelectorAll('#categoryCreatedModal .btn');
    ...
    <!-- Category Created Success Modal -->
    <div class="modal fade" id="categoryCreatedModal" tabindex="-1" aria-labelledby="categoryCreatedModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-gradient-success text-white border-0">
                    <h5 class="modal-title" id="categoryCreatedModalLabel">
                ...
                <div class="modal-body p-4 text-center">
                    <div class="mb-4">
                        <div class="icon icon-shape bg-gradient-success shadow-success text-center rounded-circle mx-auto mb-3" style="width: 80px; height: 80px;">
                            <i class="fas fa-folder text-white text-lg opacity-10" style="font-size: 2rem; line-height: 80px;"></i>
                        </div>
                        <h4 class="text-success fw-bold mb-3">🎉 Excellent!</h4>
                        <p class="text-muted mb-4">Your category has been created successfully. What would you like to do next?</p>
                        <div class="alert alert-light border-0 bg-light-success">
                            <i class="fas fa-lightbulb me-2 text-warning"></i>
                            <strong>Tip:</strong> Create courses in this category to start organizing your educational content.
                        </div>
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <div class="text-center p-3 border rounded-3 bg-light">
                                    <i class="fas fa-plus fa-2x text-primary mb-2 d-block" style="transition: all 0.3s ease;"></i>
                                    <h6 class="mb-1">Create Course</h6>
                                    <small class="text-muted">Add a new course to this category</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="text-center p-3 border rounded-3 bg-light">
                                    <i class="fas fa-list fa-2x text-info mb-2 d-block" style="transition: all 0.3s ease;"></i>
                                    <h6 class="mb-1">View All Categories</h6>
                                    <small class="text-muted">Manage all your categories</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer bg-white border-top justify-content-center">
                    <a href="#" id="createCourseBtn" class="btn btn-primary btn-lg px-4 me-3">
                        <i class="fas fa-plus me-2"></i>Create Course
                    </a>
                    <a href="{{ route('admin.educational-categories.index') }}" class="btn btn-outline-secondary btn-lg px-4">
    ...
    <script>
        // Show modal if category was just created
        @if(session('show_category_modal'))
            document.addEventListener('DOMContentLoaded', function() {
                const categoryId = {{ session('show_category_modal') }};
                const modal = new bootstrap.Modal(document.getElementById('categoryCreatedModal'));
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        const icon = document.querySelector('#categoryCreatedModal .icon-shape i');
                        if (icon) {
                ...
                // Set create course button href
                document.getElementById('createCourseBtn').href = `{{ route('admin.educational-courses.create') }}?category_id=${categoryId}`;

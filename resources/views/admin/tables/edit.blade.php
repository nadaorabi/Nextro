            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">تعديل الجدول</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">تعديل الجدول</h6>
                </nav>
            </div>
        </nav>
        <!-- End Navbar -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="جدول الفصل الأول" placeholder="أدخل عنوان الجدول">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-control-label">العام الدراسي</label>
                                            <input type="text" class="form-control" value="2023-2024" placeholder="مثال: 2023-2024">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div id="periods-container">
                                            <div class="row period-row mb-3">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="الرياضيات" placeholder="أدخل اسم المادة">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="form-control-label">المدرس</label>
                                                        <input type="text" class="form-control" value="أحمد محمد" placeholder="اسم المدرس">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                            ...
                                            <div class="row period-row mb-3">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="form-control-label">اسم المادة</label>
                                                        <input type="text" class="form-control" value="اللغة العربية" placeholder="أدخل اسم المادة">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="form-control-label">المدرس</label>
                                                        <input type="text" class="form-control" value="محمد علي" placeholder="اسم المدرس">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control">
                                                            <option>السبت</option>
                                                            <option>الأحد</option>
                                                            <option selected>الاثنين</option>
                                                            <option>الثلاثاء</option>
                                                            <option>الأربعاء</option>
                                                            <option>الخميس</option>
                                                        </select>

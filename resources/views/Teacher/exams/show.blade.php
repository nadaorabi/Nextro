              ...
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <p class="text-sm text-muted mb-0">
                    {{ $exam->submissions->count() }} out of {{ $totalStudents }} students have submitted
                  </p>
                </div>
                <div class="d-flex align-items-center">
                  <div class="me-3">
                    <span class="badge bg-gradient-info">{{ $exam->submissions->where('status', 'started')->count() }} Started</span>
                  </div>
                  <div class="me-3">
                    <span class="badge bg-gradient-warning">{{ $exam->submissions->where('status', 'submitted')->count() }} Submitted</span>
                  </div>
                  <div class="me-3">
                    <span class="badge bg-gradient-success">{{ $exam->submissions->where('status', 'graded')->count() }} Graded</span>
                  </div>
                  <div>
                    <span class="badge bg-gradient-secondary">{{ $totalStudents - $exam->submissions->count() }} Pending</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body">
                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                      <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Started At</th>
                      ...
                      <tr>
                        ...
                        <td>
                          @if($submission->started_at)
                            <span class="text-sm font-weight-bold">{{ $submission->started_at->format('M d, Y') }}</span>
                            <br>
                            <small class="text-muted">{{ $submission->started_at->format('H:i A') }}</small>
                          @else
              ...
              @else
                <div class="text-center py-5">
                  ...
                  <p class="text-sm text-muted">Students haven't submitted their exams yet.</p>
                </div>
              @endif
            </div>
          </div>

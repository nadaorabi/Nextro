...
<head>
  ...
  <title>
    إضافة امتحان جديد - {{ Auth::user()->name }}
  </title>
  <!--     Fonts and icons     -->
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">إضافة امتحان جديد</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">إضافة امتحان جديد</h6>
        </nav>
      </div>
    </nav>
    <!-- End Header -->
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex justify-content-between align-items-center">
                <h6 class="mb-0">إضافة امتحان جديد</h6>

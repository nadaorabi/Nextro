      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">تعديل الواجب</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">تعديل الواجب</h6>
        </nav>
      </div>
    </nav>
    <!-- End Header -->
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex justify-content-between align-items-center">
                <h6 class="mb-0">تعديل الواجب: {{ $assignment->title }}</h6>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control @error('type') is-invalid @enderror" 
                        ...
                        <option value="manual" {{ old('type', $assignment->type) == 'manual' ? 'selected' : '' }}>يدوي (تصحيح المعلم)</option>
                        <option value="auto" {{ old('type', $assignment->type) == 'auto' ? 'selected' : '' }}>آلي (تصحيح تلقائي)</option>
                      </select>
                      @error('type')
                          <div class="invalid-feedback">{{ $message }}</div>
                      @enderror

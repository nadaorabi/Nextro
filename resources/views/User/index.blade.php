...
<body>
  ...
  <div id="success-toast" style="
      ...
      min-width: 320px;
      max-width: 90%;
      background: linear-gradient(135deg, rgba(40,167,69,0.9), rgba(72,201,116,0.8));
    ...
    <div style="display: flex; align-items: center; padding: 16px;">
      ...
      <span style="flex: 1; font-size: 15px;">{{ session('success') }}</span>
    </div>
    <div id="progress-bar" style="
        height: 4px;
        background: linear-gradient(to right, #ffffffaa, #ffffff44);
        width: 100%;
